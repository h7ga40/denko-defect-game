...
const sheets = [
  ...
  ['loop', '49a67cca90503dcb342c85174357902d.jpg', null, '輪づくり', 1, [
    ...
    ['輪の巻付きが不足', q('loop-short')],
    ['輪の先端が重なっている', q('loop-overlap')],
    ['ねじの外に裸銅線が長く出る', q('loop-long-tail')],
    ['ねじ頭に対して輪が大きすぎる', q('loop-oversized')],
  ]],
  ['cable', 'f3aea900d6f3820fa079887887f0909b.jpg', null, '電線加工', 1, [
    ['シースの縦割りが残っている', q('cable-split-sheath')],
    ['絶縁被覆の傷から導体が見える', c('cable_insulation_damage')],
    ['導体に深い傷がある', q('cable-conductor-cut')],
  ]],
  ['ring-a', '6c0f3fe476e5771d3e1b3838eaeb22cb.jpg', null, 'リングスリーブ', 1, [
    ['先端の銅線が長く残っている', c('ring_sleeve_conductor_overhang')],
    ['スリーブ本体が壊れている', q('ring-sleeve-damaged')],
  ...
  ['ring-b', '02ed6a716ef87fcd61b20c5fa97047a7.jpg', null, 'リングスリーブ', 5, [
    ...
    ['不要なスリーブが電線に残る', q('ring-sleeve-extra')],
    ['外装端から接続部までの絶縁電線が短い', q('ring-sleeve-short-insulation')],
    ['スリーブ根元の裸銅線が長すぎる', q('ring-sleeve-long-bare')],
  ]],
