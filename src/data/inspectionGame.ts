...
export const inspectionTemplates: InspectionTemplate[] = [
  ...
  },
  {
    ...
    question: "埋込コンセント（接地極付）の接地線を判定してください。",
  ...
  },
  {
    ...
    normalExplanation: "接続する電線の太さと本数に合うリングスリーブを使用しています。",
    defectExplanation: "接続する電線の太さと本数に対して、リングスリーブのサイズが合っていません。",
  },
  {
    ...
    question: "リングスリーブの圧着部を判定してください。",
    choices: ["欠陥なし", "絶縁被覆をかみ込んでいる", "リングスリーブの刻印が不適合", "白線と黒線の接続が逆"],
    defectAnswer: "絶縁被覆をかみ込んでいる",
    normalExplanation: "心線だけがリングスリーブ内で圧着されています。",
    defectExplanation: "絶縁被覆をかみ込んだまま圧着しており、心線が正しく圧着されていません。",
  },
  {
    id: "outlet-box",
    title: "アウトレットボックス",
  ...
  {
    id: "connector-wire-count",
    title: "差込形コネクタ",
    overviewLabel: "コネクタ",
    overviewType: "connector",
    defectType: "push_connector_wrong_wire_count",
    question: "差込形コネクタの本数選定を判定してください。",
    choices: ["欠陥なし", "接続本数に合わないコネクタを使用している", "心線の差し込み不足", "外装がボックス内に十分入っていない"],
    defectAnswer: "接続本数に合わないコネクタを使用している",
    normalExplanation: "接続する心線の本数に合う差込形コネクタを使用しています。",
    defectExplanation: "接続本数に対して、差込形コネクタの極数が足りていません。",
  },
  {
    id: "terminal-block",
    title: "端子台",
  ...
  },
  {
    ...
    question: "引掛シーリングローゼットの白線・黒線の接続を判定してください。",
