...
export const candidateDiagrams: CandidateDiagram[] = [
  {
    ...
    connections: [
      { id: "1-power-box1", from: "p", to: "j1", color: "black", label: "EM-EEF 2.0-2C", cable: hozanCable("1-em-eef", 150) },
      { id: "1-box1-ceiling", from: "j1", to: "c", color: "black", label: "イ", cable: hozanCable("1-vvf-1", 150, { sourceStockPieceIndex: 0 }) },
      { id: "1-box1-switch-a", from: "j1", to: "sw", color: "black", label: "Hイ/ロ/ハ VVF 1.6-2C ×2", cable: hozanCable("1-vvf-1", 150, { sourceStockPieceIndex: 0 }) },
      { id: "1-box1-switch-b", from: "j1", to: "sw", color: "black", cable: hozanCable("1-vvf-1", 150, { sourceStockPieceIndex: 1 }) },
      { id: "1-box1-box2", from: "j1", to: "j2", color: "black", label: "VVF 1.6-3C", cable: hozanCable("1-vvf-2", 150) },
      { id: "1-box2-receptacle", from: "j2", to: "r", color: "black", label: "ロ", cable: hozanCable("1-vvf-1", 150, { sourceStockPieceIndex: 1 }) },
      { id: "1-box2-omitted", from: "j2", to: "omit", color: "black", label: "ハ 施工省略", cable: hozanCable("1-vvf-1", 150, { sourceStockPieceIndex: 1 }) },
    ],
    boxWirings: [
      {
        deviceId: "j1",
        groups: [
          { id: "neutral", method: "ring_sleeve", conductors: [{ cableId: "1-power-box1", coreIndex: 1 }, { cableId: "1-box1-ceiling", coreIndex: 1 }, { cableId: "1-box1-box2", coreIndex: 1 }] },
          { id: "line", method: "ring_sleeve", conductors: [{ cableId: "1-power-box1", coreIndex: 0 }, { cableId: "1-box1-switch-a", coreIndex: 0 }] },
          { id: "switch-i", method: "ring_sleeve", conductors: [{ cableId: "1-box1-ceiling", coreIndex: 0 }, { cableId: "1-box1-switch-a", coreIndex: 1 }] },
          { id: "switch-ro", method: "ring_sleeve", conductors: [{ cableId: "1-box1-switch-b", coreIndex: 0 }, { cableId: "1-box1-box2", coreIndex: 2 }] },
          { id: "switch-ha", method: "ring_sleeve", conductors: [{ cableId: "1-box1-switch-b", coreIndex: 1 }, { cableId: "1-box1-box2", coreIndex: 0 }] },
        ],
      },
      {
        deviceId: "j2",
  ...
  },
  {
    ...
    connections: [
      { id: "2-power-box1", from: "p", to: "j1", color: "black", label: "VVF 2.0-2C", cable: hozanCable("2-vvf-3", 150) },
      { id: "2-box1-receptacle", from: "j1", to: "r1", color: "black", label: "イ", cable: hozanCable("2-vvf-1", 150) },
      { id: "2-box1-box2", from: "j1", to: "j2", color: "black", label: "VVF 1.6-3C", cable: hozanCable("2-vvf-2", 150) },
      { id: "2-box2-frame", from: "j2", to: "pl", color: "black", label: "PL・スイッチ VVF 1.6-3C", cable: hozanCable("2-vvf-2", 150) },
      { id: "2-box2-omitted", from: "j2", to: "r2", color: "black", label: "イ 施工省略", cable: hozanCable("2-vvf-1", 100) },
      { id: "2-box2-outlet", from: "j2", to: "outlet2", color: "black", label: "2", cable: hozanCable("2-vvf-1", 150) },
    ...
    boxWirings: [
      {
        deviceId: "j1",
        groups: [
          { id: "neutral", method: "ring_sleeve", conductors: [{ cableId: "2-power-box1", coreIndex: 1 }, { cableId: "2-box1-receptacle", coreIndex: 1 }, { cableId: "2-box1-box2", coreIndex: 1 }] },
          { id: "line", method: "ring_sleeve", conductors: [{ cableId: "2-power-box1", coreIndex: 0 }, { cableId: "2-box1-box2", coreIndex: 0 }] },
          { id: "switch-i", method: "ring_sleeve", conductors: [{ cableId: "2-box1-receptacle", coreIndex: 0 }, { cableId: "2-box1-box2", coreIndex: 2 }] },
        ],
      },
      {
        deviceId: "j2",
  ...
  },
  {
    ...
    connections: [
      { id: "6-omitted-box1", from: "c1", to: "j1", color: "black", label: "施工省略", cable: hozanCable("6-vvf-1", 100) },
      { id: "6-box1-switch", from: "j1", to: "sw1", color: "black", label: "イ3", cable: hozanCable("6-vvf-2", 150) },
      { id: "6-box1-box2", from: "j1", to: "j2", color: "black", cable: hozanCable("6-vvf-2", 150) },
      { id: "6-ceiling-box1", from: "c2", to: "j1", color: "black", label: "イ", cable: hozanCable("6-vvf-1", 150) },
      { id: "6-box2-outlet", from: "j2", to: "outlet", color: "black", label: "露出形", cable: hozanCable("6-vvf-1", 150) },
      { id: "6-box2-switch", from: "j2", to: "sw2", color: "black", label: "イ3", cable: hozanCable("6-vvf-2", 150) },
      { id: "6-box2-power", from: "j2", to: "p", color: "black", label: "VVF 2.0-2C", cable: hozanCable("6-vvf-3", 150) },
    ],
    boxWirings: [
      {
        deviceId: "j1",
      ...
      },
      {
        deviceId: "j2",
        groups: [
          { id: "neutral", method: "ring_sleeve", conductors: [{ cableId: "6-box1-box2", coreIndex: 1 }, { cableId: "6-box2-outlet", coreIndex: 1 }, { cableId: "6-box2-power", coreIndex: 1 }] },
          { id: "line", method: "ring_sleeve", conductors: [{ cableId: "6-box2-outlet", coreIndex: 0 }, { cableId: "6-box2-switch", coreIndex: 0 }, { cableId: "6-box2-power", coreIndex: 0 }] },
          { id: "traveler-1", method: "ring_sleeve", conductors: [{ cableId: "6-box1-box2", coreIndex: 0 }, { cableId: "6-box2-switch", coreIndex: 1 }] },
          { id: "traveler-2", method: "ring_sleeve", conductors: [{ cableId: "6-box1-box2", coreIndex: 2 }, { cableId: "6-box2-switch", coreIndex: 2 }] },
        ],
      },
    ],
    mountingFrames: [
  ...
  },
  {
    ...
    connections: [
      { id: "7-power-box1", from: "p", to: "j1", color: "black", label: "VVF 2.0-2C", cable: hozanCable("7-vvf-3", 150) },
      { id: "7-box1-switch", from: "j1", to: "sw1", color: "black", label: "イ3", cable: hozanCable("7-vvf-2", 150) },
      { id: "7-box1-box2", from: "j1", to: "box", color: "black", label: "VVF 1.6-3C", cable: hozanCable("7-vvf-2", 150) },
      { id: "7-box2-receptacle", from: "box", to: "r1", color: "black", label: "イ", cable: hozanCable("7-vvf-1", 150) },
      ...
      { id: "7-box2-omitted", from: "box", to: "r2", color: "black", label: "イ 施工省略", cable: hozanCable("7-vvf-1", 250) },
      { id: "7-box2-switch3", from: "box", to: "sw3", color: "black", label: "イ3", cable: hozanCable("7-vvf-2", 250) },
    ],
    boxWirings: [
      {
        deviceId: "j1",
        groups: [
          { id: "neutral", method: "ring_sleeve", conductors: [{ cableId: "7-power-box1", coreIndex: 1 }, { cableId: "7-box1-box2", coreIndex: 1 }] },
          { id: "line", method: "ring_sleeve", conductors: [{ cableId: "7-power-box1", coreIndex: 0 }, { cableId: "7-box1-switch", coreIndex: 0 }] },
          { id: "traveler-1", method: "ring_sleeve", conductors: [{ cableId: "7-box1-switch", coreIndex: 1 }, { cableId: "7-box1-box2", coreIndex: 0 }] },
          { id: "traveler-2", method: "ring_sleeve", conductors: [{ cableId: "7-box1-switch", coreIndex: 2 }, { cableId: "7-box1-box2", coreIndex: 2 }] },
        ],
      },
      {
        deviceId: "box",
  ...
  },
  {
    ...
    connections: [
      ...
      { id: "8-box-ceiling", from: "box", to: "c1", color: "black", label: "イ", cable: hozanCable("8-vvf-1", 250, { sourceStockPieceIndex: 1 }) },
      { id: "8-box-receptacle", from: "box", to: "r", color: "black", label: "ロ", cable: hozanCable("8-vvf-1", 250, { sourceStockPieceIndex: 1 }) },
      { id: "8-box-omitted", from: "box", to: "c2", color: "black", label: "ハ 施工省略", cable: hozanCable("8-vvf-1", 150, { sourceStockPieceIndex: 1 }) },
    ],
    boxWirings: [{
      deviceId: "box",
      groups: [
